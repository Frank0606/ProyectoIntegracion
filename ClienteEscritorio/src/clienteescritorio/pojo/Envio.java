...
public class Envio {
    ...
    public String toStringAll() {
        return "Envio{" + "idEnvio=" + idEnvio + ", destino=" + destino + ", calle=" + calle + ", numeroGuia=" + numeroGuia + ", costoEnvio=" + costoEnvio + ", numero=" + numero + ", colonia=" + colonia + ", cp=" + cp + ", ciudad=" + ciudad + ", estado=" + estado + ", estatus=" + estatus + ", historialEstados=" + historialEstados + ", idCliente=" + idCliente + ", nombreCliente=" + nombreCliente + ", idColaborador=" + idColaborador + ", nombreColaborador=" + nombreColaborador + '}';
    }
