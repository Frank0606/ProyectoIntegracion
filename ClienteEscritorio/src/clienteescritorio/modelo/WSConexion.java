...
public class WSConexion {
    ...
    public static RespuestaHTTP peticionGET(String url) {
        ...
        try {
            ...
            HttpURLConnection conexionHttp = (HttpURLConnection) urlDestino.openConnection(); //Conexion UR mediante HTTP
            conexionHttp.setRequestMethod("GET");
            int codigoRespuesta = conexionHttp.getResponseCode(); //En esta linea hace la peticion (http)
